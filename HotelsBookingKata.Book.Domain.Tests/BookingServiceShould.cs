...
public class BookingServiceShould
{
    ...
    public void CreateBookingShouldContainAllBookingInformationIncludingTheId()
    {
        var expectedBookingDto = new BookingDto(
            "efeb449a-793a-4b30-9291-1f89f571d4d6",
            "95080440G",
            "37750641M",
            "Double",
        ...
        _hotelService
            .GetNumberOfRoomsByTypeAndHotel(expectedBookingDto.HotelId, expectedBookingDto.RoomType)
            .Returns(1);
        const string expectedId = "efeb449a-793a-4b30-9291-1f89f571d4d6";
        _uniqueIdGenerator.Generate().Returns(expectedId);

        var bookingResultDto = _bookingService.Book(
            expectedBookingDto.EmployeeId,
            expectedBookingDto.HotelId,
            expectedBookingDto.RoomType,
            expectedBookingDto.CheckIn,
            expectedBookingDto.CheckOut,
            out var bookingDto
        );
    ...
    public void FailToCreateBookingIfTheCheckOutDateIsNotLaterThanTheCheckInDate()
    {
        ...
        var inputBookingDto = new BookingDto(
            "efeb449a-793a-4b30-9291-1f89f571d4d6",
            "95080440G",
            "37750641M",
            "Double",
        ...
        var bookingResultDto = bookingService.Book(
            inputBookingDto.EmployeeId,
            inputBookingDto.HotelId,
            inputBookingDto.RoomType,
            inputBookingDto.CheckIn,
            inputBookingDto.CheckOut,
            out var bookingDto
        );
    ...
    public void FailToCreateBookingIfTheHotelDoesNotHaveTheRoomType()
    {
        ...
        var hotelService = Substitute.For<IHotelService>();
        hotelService
            .GetNumberOfRoomsByTypeAndHotel(inputBookingDto.HotelId, inputBookingDto.RoomType)
            .Returns(0);
        var uniqueIdGenerator = Substitute.For<IUniqueIdGenerator>();
        var bookingRepository = Substitute.For<IBookingRepository>();
    ...
    )
    {
        ...
        _bookingRepository
            ...
            .Returns(
                [
                    new Booking(
                        "efeb449a-793a-4b30-9291-1f89f571d4d7",
                        "95080440G",
                        "37750641M",
                        "Double",
                        new DateTime(2024, 5, 26),
